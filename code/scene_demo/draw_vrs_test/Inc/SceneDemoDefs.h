...
{
    // window
    g_SceneDemoConfig.window.width = 1920;
    g_SceneDemoConfig.window.height = 1280;
    ...
    // dirs
    g_SceneDemoConfig.directory.dirSpvFiles = "../code/scene_demo/draw_vrs_test/Spirv/";
...
static framework::DrawVrsTest* CreateSceneRender()
{
    return new framework::DrawVrsTest;
}
