...
void DrawAttachmentShadingRateThread::CreateRenderPasses()
{
    // subpass
    ...
    if (vkCreateRenderPass2(RenderBase::GetDevice(), &renderPassInfo, nullptr, &mMainRenderPass) != VK_SUCCESS) {
        throw std::runtime_error("failed to create render pass!");
    }
}

void DrawAttachmentShadingRateThread::CleanUpRenderPasses()
{
    vkDestroyRenderPass(RenderBase::mDevice->Get(), mMainRenderPass, nullptr);
}

void DrawAttachmentShadingRateThread::CreatePipelines()
{
    // create shader
...
void DrawAttachmentShadingRateThread::CleanUpPipelines()
{
