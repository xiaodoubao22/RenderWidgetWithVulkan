...
void DrawTriangleThread::CreateRenderPasses()
{
    // subpass
...
void DrawTriangleThread::CleanUpRenderPasses()
{
    vkDestroyRenderPass(RenderBase::mDevice->Get(), mMainRenderPass, nullptr);
}

void DrawTriangleThread::CreatePipelines()
{
    // create shader
...
void DrawTriangleThread::CleanUpPipelines()
{
